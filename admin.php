...
<html lang="id-id">
    <head>
        ...
        <title>Pengadilan Negeri Slawi</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="dashboard.php"><img src="assets/img/logo-bps.png.png" width="170px" alt=""></a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Zulfan Firdaus Sofyan</div>
                        </div>
                    </div>
                </footer>
            </div>
